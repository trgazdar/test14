...
class fleet_diagnose(models.Model):
    ...
    def _compute_quotation_id(self):
        for diagnose in self:
            quo_order_ids = self.env['sale.order'].search([('state', '=', 'draft'), ('diagnose_id', '=', diagnose.id)])            
    ...
    def _compute_saleorder_id(self):
        for diagnose in self:
            ...
            so_order_ids = self.env['sale.order'].search([('state', '=', 'sale'), ('diagnose_id', '=', diagnose.id)])            
