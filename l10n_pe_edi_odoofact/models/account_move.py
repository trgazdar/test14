...
class AccountMove(models.Model): 
    ...
    l10n_pe_edi_retention_type_id = fields.Many2one('l10n_pe_edi.catalog.23', string='Retention Type')
    ...
    l10n_pe_edi_base_retention = fields.Monetary(string='Base Retention', store=True, compute='_compute_retention', tracking=True)
    ...
    def _compute_retention(self):
        self.l10n_pe_edi_base_retention = 0.0
        self.l10n_pe_edi_total_retention = 0.0
        for move in self:
            if move.l10n_pe_edi_retention_type_id:
                move.l10n_pe_edi_base_retention = move.l10n_pe_edi_amount_base * (move.l10n_pe_edi_retention_type_id.rate / 100)
    ...
    def action_post(self):
        if self.move_type in ['out_invoice', 'out_refund', 'out_receipt'] and self.l10n_pe_edi_is_einvoice:
            if self.amount_total > 700 and not self.partner_id.vat:
                raise UserError(_('Please Define the Customer Document Number.'))
            
            if self.l10n_pe_edi_is_advance and self.l10n_pe_edi_operation_type != '4':
    ...
    def _get_invoice_values_odoofact(self):
        ...
        values = {
            ...
            'retencion_tipo': self.l10n_pe_edi_retention_type_id and self.l10n_pe_edi_retention_type_id.code or '',
            'retencion_base_imponible': abs(self.l10n_pe_edi_base_retention),
            'total_retencion': abs(self.l10n_pe_edi_total_retention),
